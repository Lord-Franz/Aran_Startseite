...
const FootNote = () => {
    return (
        <div className={"h-full flex items-center justify-center bg-[#563045] mt-5"}>
            ...
            <a href={"https://land-von-aran.de/forumcore/index.php?datenschutzerklaerung/"} className={"px-3 text-white hover:text-red-500 hover:font-bold"}>Datenschutzerklärung</a>
